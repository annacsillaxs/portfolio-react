	...
	return (
		<section id="experience" className="experience">
			<div className="title-box--sm">
				<h2 className="center fs-600 ff-sans-cond fw-700">Professional Experience</h2>
				<div className="underline--sm center"></div>
			</div>

			<div className="role flow">
				<div className="role-header flex">
					<h3 className="ff-sans-cond fs-500 fw-700">Software Engineer &mdash; Abound</h3>
					<p className="ff-sans-cond uppercase fs-300 fw-700 letter-spacing-4 text-lighter">Mar 2022 &ndash; Present</p>
				</div>
				<p>
					Full-stack engineer on a large fintech monorepo supporting multiple white-labelled clients and financial products. Work spans frontend, backend, APIs and
					configuration-driven multi-tenant architecture &mdash; 170+ tracked tickets delivered across four years, with a focus on incremental delivery, production
					stability and maintainable code.
				</p>
			</div>
